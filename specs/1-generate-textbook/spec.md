...
**Why this priority**: This is the core purpose of the textbook, providing essential learning content with an appealing and engaging frontend that keeps readers interested.
...
4. **Given** I am reading the textbook, **When** I view the content, **Then** I see an appealing frontend with engaging visual elements that maintain my interest.
...
- **FR-002**: The textbook chapters MUST be concise (maximum 1,500 words each), well-structured with clear headings and subheadings, technically accurate, and include 1-3 diagrams/code snippets, "Key Ideas", and "Practical Checklist" sections. Chapters MUST contain minimal math (less than 10% of content). (Constitution 2.1)
- **FR-013**: The textbook frontend MUST be visually appealing and engaging with appropriate use of diagrams, color schemes, typography, and interactive elements to maintain reader interest and enhance learning experience. (Constitution 2.1)
...
- **FR-009**: The RAG system MUST utilize lightweight embedding models and CPU-friendly LLMs (or hosted equivalent) with low temperature (0.2) and small max tokens (500). (Constitution 2.3, 7)
...
- **FR-011**: The system MUST optimize for fast builds (under 3 minutes) and deployment to GitHub Pages. (Constitution 1, 3.1 (4), 7)
...
- **SC-005**: The textbook UI MUST be visually minimal, legible (minimum 4.5:1 color contrast ratio), and responsive (mobile-first design with breakpoints at 768px and 1024px) across common desktop and mobile browsers. The UI MUST include engaging elements such as relevant diagrams, interactive elements, and well-designed typography to maintain reader engagement.
- **SC-006**: The chatbot response time (p95) MUST be under 8 seconds on free-tier infrastructure.
- **SC-007**: The complete textbook (including translations) MUST build and deploy within GitHub Actions free runner time limits (20 minutes).
